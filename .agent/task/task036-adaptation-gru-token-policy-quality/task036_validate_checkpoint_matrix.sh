...
OUT="${OUT:-${ROOT}/outputs/task036/full_validation_${CONSUMER}_${LABEL}}"
...
case "${CONSUMER}" in
  adapt)
    DYNAMIC_TASK="${DYNAMIC_TASK:-Unitree-G1-Gripper-Flat-Task036-AdaptK4-DynamicMotorFailure-Fast1p6}"
    DEADGRID_TASK="${DEADGRID_TASK:-Unitree-G1-Gripper-Flat-Task036-AdaptK4-FocusedDeadGrid-Fast2p0}"
    ;;
  gru)
    DYNAMIC_TASK="${DYNAMIC_TASK:-Unitree-G1-Gripper-Flat-Task036-GruK4-DynamicMotorFailure-Fast1p6}"
    DEADGRID_TASK="${DEADGRID_TASK:-Unitree-G1-Gripper-Flat-Task036-GruK4-FocusedDeadGrid-Fast2p0}"
    ;;
  token)
    DYNAMIC_TASK="${DYNAMIC_TASK:-Unitree-G1-Gripper-Flat-Task036-TokenK4-DynamicMotorFailure-Fast1p6}"
    DEADGRID_TASK="${DEADGRID_TASK:-Unitree-G1-Gripper-Flat-Task036-TokenK4-FocusedDeadGrid-Fast2p0}"
    ;;
  *)
...
export OUT LABEL CHECKPOINT CONSUMER
...
summary_path = out / "task036_full_validation_summary.json"
